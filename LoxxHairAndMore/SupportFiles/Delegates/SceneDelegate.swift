...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func fetchDataFromServer(){
        ...
        NetworkManager().fetchAllData({
                ...
                //TODO: KIJK TUTORIAL OVER GEBRUIKEN VAN WEAK SELF EN BEPAAL OF DIT WEL OF NIET NODIG IS!!
    ...
    private func setReachabilityNotifier(){
        ...
        // attempt to initiliase a Reachability object to monitor network connectivity changes
    ...
    @objc private func reachabilityChanged(note: Notification){
        ...
        - Wait for a change in the network to appear. Using the reachability class ensures that, if the user opens the app without
          having an internet connection, and an internet connection becomes active whilst the user is using the app, the most recent
          data is fectched without the user having to for example explicitly press a reload button
    ...
    private func initIndicator(){
            ...
            // initiliase the loading indicator itself
    ...
    private func initIndicatorView(){
        ...
        // init the transparent view with a black undertone that the indicator will be displayed in
